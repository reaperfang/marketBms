  ...
  <div class="electronic-face-sheet">
    ...
    <section class="table-box">
      <div class="content-header">
          ...
          <el-button v-permission="['订单', '电子面单', '默认页', '新建']" @click="$router.push('/set/newElectronicFaceSheet')" class="border-button">新建</el-button>
      </div>
      <div class="table">
        <el-table
          v-loading="loading"
          ...
          <el-table-column label="操作">
            <template slot-scope="scope">
              <div class="operate-box">
                <span v-permission="['订单', '电子面单', '默认页', '查看']" @click="$router.push('/set/newElectronicFaceSheet?id=' + scope.row.id + '&expressCompanyCode=' + scope.row.expressCompanyCode + '&detail=' + true)">查看</span>
                <span v-permission="['订单', '电子面单', '默认页', '修改']" @click="$router.push('/set/newElectronicFaceSheet?id=' + scope.row.id + '&expressCompanyCode=' + scope.row.expressCompanyCode)">编辑</span>
