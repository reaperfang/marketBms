    ...
    <section>
      <div>
        ...
        <el-button
          ...
          @click="isCategory = true; showTableCheck = false; operateType = 2"
        >类目改价</el-button>
      </div>
      ...
      <div class="table-footer">
        ...
        ></el-cascader>
        <div class="tc">
          <el-button @click="priceChange" v-if="operateType" type="primary">一键改价</el-button>
