...
import dialogSyncArticle from '@/views/shop/dialogs/materialDialogs/dialogSyncArticle';
import dialogDelete from '@/views/shop/dialogs/materialDialogs/dialogDelete';
import dialogQRcode from '@/views/shop/dialogs/materialDialogs/dialogQRcode';
export default {
