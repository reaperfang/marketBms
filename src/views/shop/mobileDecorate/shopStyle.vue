<template>
  <div class="shop_style_wrapper">
    ...
    <ul class="demo_list tile-list n3" v-if="selectedItem" v-calcHeight="160+78+40+22">
      <li>
        <img v-if="require('@/assets/images/shop/style/goodsDetail'+ selectedItem.type +'.png')" :src="require('@/assets/images/shop/style/goodsDetail'+ selectedItem.type +'.png')" alt="">
        <img v-else :src="require('@/assets/images/shop/style/goodsDetail'+ selectedItem.type +'.png')" alt="">
        <p>商品详情</p>
      </li>
      <li>
        <img v-if="require('@/assets/images/shop/style/shoppingCar'+ selectedItem.type +'.png')" :src="require('@/assets/images/shop/style/shoppingCar'+ selectedItem.type +'.png')" alt="">
        <img v-else :src="require('@/assets/images/shop/style/shoppingCar'+ selectedItem.type +'.png')" alt="">
        <p>购物车</p>
      </li>
      <li>
        <img v-if="require('@/assets/images/shop/style/orderDetail'+ selectedItem.type +'.png')" :src="require('@/assets/images/shop/style/orderDetail'+ selectedItem.type +'.png')" alt="">
