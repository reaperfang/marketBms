      ...
      <el-table-column label="操作">
        <template slot-scope="scope">
            <div class="btns clearfix">
                ...
                <span v-if="scope.row.enableShow == true" @click="handleAble($event, scope.row, 1)">启用</span>
                <span v-if="scope.row.disableShow == true" @click="handleAble($event, scope.row, 0)">禁用</span>
