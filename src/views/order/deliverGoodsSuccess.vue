        ...
        <div class="success-icon">
            ...
            <div class="link-box">
                <template v-if="$route.query.type == 'deliverGoods'">
                    ...
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: $route.query.id,printType:0})">打印配送单</a>
                ...
                <template v-else-if="$route.query.type == 'orderBulkDelivery'">
                    ...
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: $route.query.ids,printType:0})">打印配送单</a>
                ...
                <template v-else-if="$route.query.type == 'orderAfterDeliverGoods'">
                    ...
                    <span v-if="$route.query.print == 'false'">或</span> 
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: this.$route.query.id, afterSale: true,printType:0})">打印配送单</a>
                ...
                <template v-else-if="$route.query.type == 'afterSaleBulkDelivery'">
                    ...
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: this.$route.query.ids, afterSale: true,printType:0})">打印配送单</a>
                ...
                <template v-else-if="$route.query.type == 'supplementaryLogistics'">
                    ...
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: this.$route.query.id,printType:0})">打印配送单</a>
                    <!-- <router-link :to="{ path: '/order/printDistributionSheet', query: {ids: this.$route.query.id} }">打印配送单</router-link> -->
                </template>
                <template v-else-if="$route.query.type == 'batchSupplementaryLogistics'">
                    ...
                    <a href="javascript:void(0)" @click="handlePrintListOpen('/order/printDistributionSheet',{ids: this.$route.query.ids,printType:0})">打印配送单</a>
                    <!-- <router-link :to="{ path: '/order/printDistributionSheet', query: {ids: this.$route.query.ids} }">打印配送单</router-link> -->
                </template>
            </div>
        </div>
