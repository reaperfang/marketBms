<template>
    <div class="flow_path">
        <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
            <el-tab-pane name="开店准备">
                ...
                <div class="f_list">
                    ...
                    <div class="f_list_r">
                        ...
                        <p>
                            <img :src="require('@/assets/images/star.png')" alt="">
                            <span @click="linkTo({text:'开通短信包'})">
                                开通短信包
                            </span>
                            <i>并</i>
                            <span @click="linkTo({text:'设置模版和签名'})">
                                设置模版和签名
                            </span>
                        </p>
                        <p>
                            <img :src="require('@/assets/images/star.png')" alt="">
                            <span @click="linkTo({text:'创建商品',url:'/goods/addGoods'})">
                                创建商品
                            </span>
                            <i>或</i> 
                             <span @click="linkTo({text:'商品批量导入',url:'/goods/import'})">
                                 商品批量导入
                             </span>
                        </p>
            ...
            <el-tab-pane label="营销推广" name="营销推广">
                <div class="f_list">
                    <div class="f_list_l">
                        <p @click="linkTo({text:'超级海报'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            超级海报
                        </p>
                        <p @click="linkTo({text:'限时折扣'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            限时折扣
                        </p>
                        <p @click="linkTo({text:'N元N件'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            N元N件
                        </p>
                        <p @click="linkTo({text:'更多'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            更多 &#62;&#62;
                        </p>
                    </div>
                    <div class="f_list_r">
                        <p @click="linkTo({text:'多人拼团'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            多人拼团
                        </p>
                        <p @click="linkTo({text:'节日有礼'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            节日有礼
                        </p>
                        <p @click="linkTo({text:'满减满折'})">
                            <img :src="require('@/assets/images/star.png')" alt="">
                            满减满折
                        </p>
                    </div>
    ...
    methods:{
        ...
        linkTo(item){
            if(item.text == '绑定微信公众号'){
                ...
                this.$router.push({path:'/apply',query:{paths:'/application/toolapp/paySms',applyId:'2'}})
                this.SETCURRENT(8)
                ...
                this.$router.push({path:'/apply',query:{paths:'/application/promotion/time',applyId:'4'}})
                this.SETCURRENT(8)
            }else if(item.text == 'N元N件'){
                this.$router.push({path:'/apply',query:{paths:'/application/promotion/packbuy',applyId:'4'}})
                this.SETCURRENT(8)
            }else if(item.text == '多人拼团'){
                this.$router.push({path:'/apply',query:{paths:'/application/feature/group',applyId:'5'}})
                this.SETCURRENT(8)
...
/deep/{
    ...
    .el-tabs__header{
        ...
        .el-tabs__item{
            ...
            text-align: center;
            border-bottom:none;
            border-left:1px solid rgba(101,94,255,1);
        }
        .is-active{
