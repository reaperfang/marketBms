    ...
    <div>
        ...
        <div class="u_item">
            ...
            <div class="u_b">
                ...
                <p class="title"><span>用户管理：</span>用户数据全部打通，无需单独管理；</p>
                <p><span></span>会员特权，营造会员权益的专属化。</p>
                <p class="title"><span>互动营销：</span>满减、优惠券、限时折扣促销类型众多，提高二次复购；</p>
                <p><span></span>多种玩法，海报、代付、拼团、秒杀，提高粉丝量。</p>
                <p class="title"><span>财务查询：</span>展示营收概况及趋势分析、用户余额、推客奖励、积分明细及物流成本核算。</p>
                <p class="title"><span>智能运营：</span>订单量、客单价、人均消费分析；交易时间、用户类型、复购率分析，快速了解</p>
                <p><span></span>用户交易情况；好评率、差评率分析提高口碑宣传。</p>
            </div>
        </div>
        <!-- <div class="u_item">
            <div class="u_t p2">
