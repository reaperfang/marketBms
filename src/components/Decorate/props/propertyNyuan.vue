  ...
  <el-form ref="ruleForm" :model="ruleForm" :rules="rules" label-width="80px">
    ...
    <div class="block form">
      <el-form-item label="显示内容" prop="buttonText" ref="itemShowContents">
        ...
        <el-input ref="buyInput" v-if="ruleForm.showContents.includes('7') && [3,4,7,8].includes(ruleForm.buttonStyle) && (ruleForm.listStyle !== 3 && ruleForm.listStyle !== 6)" v-model="ruleForm.buttonText" placeholder="请输入标题"></el-input>
      </el-form-item>
